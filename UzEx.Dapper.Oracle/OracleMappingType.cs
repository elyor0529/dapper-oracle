...
{
    /// <summary>
    ///     Enum for mapping to Oracle native DB types.  Only for use together with Dapper and
    ///     <see cref="OracleDynamicParameters" />
    ...
    /// <summary>
    ///     BulkMapping enum to map Collection type for parameter when using PL/Sql associative arrays without referencing
    ///     oracle directly.
    /// </summary>
